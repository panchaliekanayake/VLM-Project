#siglip - Eye Contact (with face-crop + margin threshold)
...
if __name__ == "__main__":
    ...
    csv_path = os.path.join(OUTPUT_DIR, f"{base}_eye_contact_siglip_dense_face_threshold.csv")
    df_sorted.to_csv(csv_path, index=False)

    duration_sec = total_frames / fps if fps > 0 else float("nan")
    print("\n--- Summary (SigLIP • Eye Contact) ---")
