...
# ======================
# pip install transformers accelerate scikit-learn openpyxl tqdm
...
# ======================
# 6. Helper function: predict score for a chunk
# ======================
...
# ======================
print(final_df[["Participant", "Predicted_StructuredAnswers", "StructuredAnswers"]].head(30))
...
# ======================
# 11. Linear Regression: Predicted vs Actual
# ======================
...
clean_df = final_df.dropna(subset=["Predicted_StructuredAnswers", "StructuredAnswers"])

X = clean_df[["Predicted_StructuredAnswers"]].values
y = clean_df["StructuredAnswers"].values
...
plt.xlabel("Actual StructuredAnswers Score")
plt.ylabel("Predicted StructuredAnswers (Linear Fit)")
plt.title("Predicted vs Actual StructuredAnswers (Linear Regression)")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.show()
